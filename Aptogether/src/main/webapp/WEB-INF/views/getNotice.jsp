					...
					<div class="panel-body">
						...
						<div class="form-group">
							<label>구분</label><input class="form-control" name="category"
								value='<c:out value="${notice.category }"/>' readonly="readonly">
						</div>
						...
						onclick="location.href='/keeper/modifyNotice?noticeSeq=<c:out value="${notice.noticeSeq }"/>'">수정
							</button>
							<button data-oper='list' class="btn btn-danger"
								onclick="location.href='/keeper/listNotice'">목록</button>
						</div>
						<!-- end  panel-body -->
					</div>
					<!-- end panel -->
